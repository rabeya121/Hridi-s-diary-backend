...
const products = [
    // ---------- SKINCARE (9) ----------
    {
        ...
        fullDescription: "A gentle, alcohol-free toner made with pure rose water to hydrate, soothe, and refresh your skin. Suitable for all skin types, helps minimize pores and balance skin pH after cleansing.",
        price: 450,
    ...
    },
    {
        ...
        fullDescription: "Powerful antioxidant serum formulated with 20% Vitamin C and Vitamin E to fade dark spots, brighten complexion, and protect against environmental damage. Lightweight, fast-absorbing formula for daily use.",
        price: 890,
    ...
    },
    {
        ...
        fullDescription: "Delivers intense, long-lasting hydration by drawing moisture into the skin at multiple layers. Plumps fine lines and restores a dewy, healthy glow. Ideal for dry and dehydrated skin.",
        price: 750,
    ...
    },
    {
        ...
        fullDescription: "Activated charcoal and tea tree oil work together to draw out impurities, excess oil, and pollutants without stripping the skin. Leaves face feeling clean, matte, and refreshed.",
        price: 380,
    ...
    },
    {
        ...
        fullDescription: "A multipurpose soothing gel made from 99% pure aloe vera extract. Calms sunburn, irritation, and redness while providing lightweight hydration. Can also be used on hair and body.",
        price: 320,
    ...
    },
    {
        ...
        fullDescription: "A high-strength Niacinamide serum that visibly reduces the appearance of enlarged pores, regulates sebum production, and improves overall skin texture with consistent use.",
        price: 680,
    ...
    },
    {
        ...
        fullDescription: "Non-greasy, broad-spectrum SPF 50+ sunscreen that protects against UVA/UVB rays while leaving a matte, no-white-cast finish. Perfect for daily wear under makeup.",
        price: 590,
    ...
    },
    {
        ...
        fullDescription: "A rich, non-sticky overnight mask infused with ceramides and peptides that work while you sleep to repair the skin barrier and restore softness by morning.",
        price: 820,
    ...
    },
    {
        ...
        fullDescription: "A cooling under-eye cream enriched with caffeine and vitamin K to visibly reduce dark circles, puffiness, and fine lines around the delicate eye area.",
        price: 560,
    ...
    // ---------- HAIRCARE (9) ----------
    {
        ...
        fullDescription: "A sulfate-free, gentle cleansing shampoo infused with argan oil to nourish dry and damaged hair, restoring softness and shine without stripping natural oils.",
        price: 480,
    ...
    },
    {
        ...
        fullDescription: "A deep conditioning treatment infused with keratin protein to repair damaged strands, reduce frizz, and leave hair silky smooth and manageable.",
        price: 520,
    ...
    },
    {
        ...
        fullDescription: "A traditional blend of onion extract and black seed oil, known for strengthening hair roots, reducing hair fall, and promoting healthy hair growth with regular use.",
        price: 350,
    ...
    },
    {
        ...
        fullDescription: "An intensive weekly treatment mask formulated with shea butter and protein complex to repair split ends, restore elasticity, and revive dull, damaged hair.",
        price: 620,
    ...
    },
    {
        ...
        fullDescription: "A gentle medicated formula with zinc pyrithione that effectively controls dandruff and soothes an itchy scalp, while keeping hair soft and manageable.",
        price: 440,
    ...
    },
    {
        ...
        fullDescription: "A lightweight, non-greasy serum that forms a protective barrier against heat damage from straighteners and blow dryers, while adding shine and reducing frizz.",
        price: 490,
    ...
    },
    {
        ...
        fullDescription: "Inspired by traditional Asian hair rituals, this fermented rice water tonic is packed with amino acids and vitamins to strengthen hair follicles and support natural growth.",
        price: 410,
    ...
    },
    {
        ...
        fullDescription: "A super-absorbent microfiber hair towel designed in a comfortable turban wrap style, reducing friction and breakage compared to regular cotton towels.",
        price: 390,
    ...
    },
    {
        ...
        fullDescription: "Handcrafted wide-tooth wooden comb designed to gently detangle wet or dry hair without causing breakage, while reducing static and frizz.",
        price: 180,
    ...
    // ---------- UNDERGARMENTS (9) ----------
    {
        ...
        fullDescription: "Made from soft, breathable cotton blend fabric with wire-free support, designed for everyday comfort without compromising on shape and coverage.",
        price: 650,
    ...
    },
    {
        ...
        fullDescription: "A lightweight, seamless bralette made with stretch fabric for a barely-there feel. Perfect for lounging or light everyday wear, with no visible lines under clothing.",
        price: 590,
    ...
    },
    {
        ...
        fullDescription: "Soft, breathable cotton panties with a high-waist design for full coverage and comfort. Includes a pack of 3 in assorted colors, perfect for daily wear.",
        price: 480,
    ...
    },
    {
        ...
        fullDescription: "A delicate lace-trim bikini panty set combining comfort and elegance. Breathable fabric with a flattering fit, available in a pack of 3 assorted colors.",
        price: 520,
    ...
    },
    {
        ...
        fullDescription: "A lightly padded, seamless T-shirt bra designed to give a smooth silhouette under fitted tops and dresses, with breathable moisture-wicking fabric.",
        price: 720,
    ...
    },
    {
        ...
        fullDescription: "A firm-control shapewear slip that smooths the tummy and hips for a seamless look under fitted outfits, while remaining breathable for all-day wear.",
        price: 890,
    ...
    },
    {
        ...
        fullDescription: "Soft cotton boyshort panties offering extra coverage and a comfortable, no-ride-up fit. Pack of 3 in classic neutral shades, great for everyday wear.",
        price: 500,
    ...
    },
    {
        ...
        fullDescription: "A medium-support sports bra made with moisture-wicking, stretch fabric that keeps you comfortable during workouts, yoga, or everyday activities.",
        price: 680,
    ...
    },
    {
        ...
        fullDescription: "A silky-smooth camisole slip designed for comfortable layering under sheer or fitted tops, with adjustable straps and a breathable, lightweight feel.",
        price: 550,
...
const seedDatabase = async () => {
    try {
        ...
        await Combo_1.default.deleteMany({});
        console.log("🌱 Seeding products...");
        const createdProducts = await Product_1.default.insertMany(products);
        console.log(`✅ ${createdProducts.length} products created`);
        const findId = (title) => createdProducts.find((p) => p.title === title)?._id;
        const combos = [
            {
                ...
                description: "A romantic self-care set featuring a glow-boosting skincare duo paired with a silky camisole slip — the perfect Valentine's gift for someone special.",
            ...
            },
            {
                ...
                description: "Celebrate Eid with radiant skin and silky hair. This gift box combines a deep-hydration serum with a nourishing shampoo-conditioner duo, beautifully packaged for gifting.",
            ...
            },
            {
                ...
                description: "Wrap up the festive season with this cozy self-care trio — an overnight repair mask, brightening eye cream, and hair growth tonic, packaged for holiday gifting.",
            ...
            },
            {
                ...
                description: "A festive beauty hamper crafted for Puja celebrations — deep cleansing, pore-refining, and hair-strengthening essentials in one elegant gift set.",
        ...
        const createdCombos = await Combo_1.default.insertMany(combos);
